...
/**
 * Rumble command rumbles the controller when the TimeofFlight sensor detects a note and while the
...
public class Rumble extends Command {
  ...
  public void execute() {
    RobotContainer.getDriverController()
        .getHID()
        .setRumble(RumbleType.kRightRumble, ManipulatorConstants.RUMBLE_SETTING);
    RobotContainer.getDriverController()
        .getHID()
        .setRumble(RumbleType.kLeftRumble, ManipulatorConstants.RUMBLE_SETTING);
    RobotContainer.getCoDriverController()
        .getHID()
        .setRumble(RumbleType.kRightRumble, ManipulatorConstants.RUMBLE_SETTING);
    RobotContainer.getCoDriverController()
        .getHID()
