...
public class MAXSwerveModule {
  ...
  // Angle between swerve module zero position and robots forward direction,
  // necessary for strafing and rotating
  private double m_chassisAngularOffset = 0;
  // Constructs a swerve module state with velocity and angle of a singular module
  ...
  public MAXSwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    ...
    // Sets angle of swerve module desired state to turning encoders position (In
    // radians per second)
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    // Adds the original angle at construction of desired state to the angular offset, accounts for
    // offset this way
